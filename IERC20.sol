...
interface IOptionalERC20 {
    ...
    function increaseAllowence(address spender, uint256 amount) external returns (bool);
    function decreaseAllowence(address spender, uint256 amount) external returns (bool);
}
